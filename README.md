...
- Runtime-поиск структуры для HUD/анонсов оптимизирован: сервер использует spatial-индекс и проверяет вход/выход из структуры только при реальном перемещении игрока по блокам.
